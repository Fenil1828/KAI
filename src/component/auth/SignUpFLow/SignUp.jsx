...
import { googleLogin } from '../../../Apis/googleApi';
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative w-full lg:w-1/2 flex flex-col items-center justify-center bg-black text-white p-4 sm:p-6 lg:p-8 shadow-2xl shadow-gray-800">
        ...
        <div className="absolute top-3 mt-6 sm:mt-0 mr-5 sm:mr-0 right-3 sm:top-5 sm:right-8 flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-black/30 backdrop-blur-xl border border-gray-500/50 rounded-2xl shadow-lg hover:border-gray-600/50 transition-all duration-300 group">
        ...
        <div className="w-full max-w-md relative z-10 backdrop-blur-sm bg-black/30 p-6 sm:p-8 rounded-2xl border border-gray-800">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-white via-gray-200 to-gray-400 text-transparent bg-clip-text">Create your account</h1>

          <div className="border-b border-b-gray-800 w-[80%] flex items-center justify-center align-middle mb-5 mx-auto">
            {/* Divider */}
          </div>
          ...
          <div className="mt-6 sm:mt-8 text-center">
            <p className="text-gray-400 text-sm sm:text-base">
              Already have an account? <a href="/login" className="text-blue-400 hover:text-blue-300 transition-colors duration-300 border-b border-transparent hover:border-blue-300">Sign in</a>
            </p>
          </div>
